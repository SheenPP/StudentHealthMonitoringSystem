    ...
    <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col sm:flex-row items-center gap-6 sm:gap-8 text-center sm:text-left">
      ...
      <div className="w-full">
        ...
        <div className="text-gray-700 space-y-2">
          <p><strong className="text-gray-900">Student ID:</strong> {student.student_id}</p>
          <p><strong className="text-gray-900">Name:</strong> {student.first_name} {student.last_name}</p>
          <p><strong className="text-gray-900">Email:</strong> {student.email}</p>
        </div>
      </div>
    </div>
  );
